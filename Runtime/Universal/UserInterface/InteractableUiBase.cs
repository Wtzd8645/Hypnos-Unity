...
namespace Morpheus.UI
{
    ...
    public abstract class InteractableUiBase : UiBase
    {
        ...
        public override void Show(UiAoHandler showCompleteCb = null)
        {
            ...
            {
                Logger.LogWarning($"[InteractableUiBase] Show UI at wrong state. Name: {gameObject.name}, State: {DisplayState}");
        ...
        public override void Hide(UiAoHandler hideCompleteCb = null)
        {
            ...
            {
                Logger.LogWarning($"[InteractableUiBase] Hide UI at wrong state. Name: {gameObject.name}, State: {DisplayState}");
