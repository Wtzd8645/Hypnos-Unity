    ...
    public sealed partial class ResourceManager
    {
        ...
        public void Initialize(ResourceConfig config)
        {
            ...
            switch (config.ResourceLoader)
            {
                ...
                default:
                {
                    Logger.LogError($"[ResourceManager] The ResourceLoader type is not supported. {config.ResourceLoader}");
                    break;
                }
            }
        }
        ...
        public void SaveArchive<T>(int archiverId, T obj, string filePath)
        {
            ...
            if (archiver == null)
            {
                Logger.LogError($"[ResourceManager] DataArchiver is null. Id: {archiverId}");
                return;
            }
            ...
            {
                Logger.LogError($"[ResourceManager] Save file failed. Exception: {e.Message}");
        ...
        private void BackUpArchive(string filePath)
        {
            ...
            {
                Logger.LogError($"[ResourceManager] Back up file failed. Exception: {e.Message}");
            }
        }
        ...
        private void RestoreArchive(string filePath)
        {
            ...
            {
                Logger.LogError($"[ResourceManager] Restore file failed. Exception: {e.Message}");
            }
        }
        ...
        public T LoadArchive<T>(int archiverId, string filePath)
        {
            ...
            {
                Logger.LogError($"[ResourceManager] Load file failed, use backup instead. Exception: {e.Message}");
        ...
        private T LoadBackupArchive<T>(DataArchiver archiver, string filePath)
        {
            ...
            {
                Logger.LogError($"[ResourceManager] Load backup file failed. Exception: {e.Message}");
                return default;
            }
        }
        #endregion
        ...
        public void UpdateAssetConfig()
        {
            ...
            {
                Logger.LogError($"[ResourceManager] Can't load AssetConfig. Exception: {e.Message}");
            }
        }
