    ...
    public static class CoreUtil
    {
        public static ISerializer CreateSerializer(CoreSerializer type)
        {
            switch (type)
            {
                ...
                default:
                {
                    Logger.LogError($"[Utility] Serializer not implemented. Type: {type}");
                    return null;
                }
            }
        }
        ...
        public static ICompressor CreateCompressor(CoreCompressor type)
        {
            switch (type)
            {
                ...
                default:
                {
                    Logger.LogError($"[Utility] Compressor not implemented. Type: {type}");
                    return null;
                }
            }
        }
        ...
        public static IEncryptor CreateEncryptor(CoreEncryptor type)
        {
            switch (type)
            {
                ...
                default:
                {
                    Logger.LogError($"[Utility] Encryptor not implemented. Type: {type}");
                    return null;
                }
            }
        }
