...
namespace Blanketmen.Hypnos.Editor.Build
{
    internal partial class AssetEditor
    {
        ...
        public static void SaveConfig(AssetEditorConfig editorConfig, EditionConfig editionConfig)
        {
            ...
            {
                Kernel.LogError($"[AssetEditor] Save AssetConfig failed. Exception: {e.Message}");
            }
        }
        ...
        public static AssetEditorConfig LoadConfig(EditionConfig editionConfig)
        {
            ...
            {
                Kernel.LogWarning($"[AssetEditor] Load AssetConfig failed. Exception: {e.Message}");
                return null;
            }
        }
        ...
        private static bool BuildFastEditorAssetConfig(AssetEditorConfig editorConfig)
        {
            ...
            try
            {
                ...
                Kernel.Log($"[AssetEditor] Build FastEditor AssetConfig successfully. OutputPath: {outputPath}");
                return true;
            }
            catch (Exception e)
            {
                Kernel.LogError($"[AssetEditor] Build FastEditor AssetConfig failed. Exception: {e.Message}");
                return false;
            }
        }
        ...
        private static void CopyAssetBundles(AssetEditorConfig editorConfig, EditionConfig editionConfig, string targetDirectory)
        {
            ...
            {
                Kernel.LogError("[AssetEditor] AssetEditorConfig or EditionConfig is null.");
                return;
            }
            ...
            {
                Kernel.LogError($"[AssetEditor] Assetbundles directory does not exist. Version: {editorConfig.version}, Path: {assetBundlesDir}");
                return;
            }
            ...
            Kernel.Log($"[AssetEditor] Copy AssetBundles successfully. Version: {editorConfig.version}, Path: {targetDirectory}");
        }
        ...
        private static void CleanAssetBundlesCopy(string targetDirectory)
        {
            ...
            Kernel.Log($"[AssetEditor] Clean AssetBundles copy successfully. Path: {targetDirectory}");
        }
        ...
        private static void BuildAssetConfig(AssetEditorConfig editorConfig, EditionConfig editionConfig, IBundleBuildResults buildResults)
        {
            ...
            {
                Kernel.LogError($"[AssetEditor] Build AssetConfig failed. Exception: {e.Message}");
            }
        }
        ...
        public static bool BuildAssetBundles(AssetEditorConfig editorConfig, EditionConfig editionConfig)
        {
            ...
            {
                Kernel.LogError($"[AssetEditor] Build AssetBundles failed. ErrorCode: {errorCode}");
                return false;
            }

            BuildAssetConfig(editorConfig, editionConfig, results);
            Kernel.Log($"[AssetEditor] Build AssetBundles successfully. OutputPath: {outputPath}");
            return true;
        }
    }
}